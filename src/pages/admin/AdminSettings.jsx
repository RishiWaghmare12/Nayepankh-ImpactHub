...
const inputCls = 'px-3 py-1.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-gray-200 focus:outline-none focus:border-indigo-500 w-48';
            ...
            {section.fields.map(field => (
              <div key={field.label} className="flex items-center justify-between">
                ...
                {field.type === 'toggle' ? (
                  ...
                  <input type={field.type} defaultValue={field.val} className={inputCls} />
                )}
              </div>
            ))}
          </div>
